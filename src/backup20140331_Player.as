package  
{
	...
	public class Player extends Entity 
	{
		...
		private var _lastmoveX:Number = 0;
		private var _lastmoveY:Number = 0;
		...
		private function move(dx:Number,dy:Number):void
		{
			...
			if (collide("maze", x + dx * adjustX, y + dy * adjustY)) { 
				// hitting a corner
				if (_lastmoveX > 0 ) { adjustY = 0; }
				else { adjustX = 0;}
			}
			...
			//if (collide("maze", x, y + adjustY)) {
				//adjustY = 0;
			//}
			_lastmoveX = dx*adjustX;
			_lastmoveY = dy*adjustY;
